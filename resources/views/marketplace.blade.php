...
@section('content')
    <div role="alert" class="alert alert-warning">
        Those plugins are from our Tec community <a href="https://marketplace.tecdynamics.co.uk/products"
                                                    target="_blank">marketplace.tecdynamics.co.uk/products</a>. We regret to inform
    ...
    <plugin-list plugin-list-url="{{ route('plugins.marketplace.ajax.list') }}" plugin-remove-url="{{ route('plugins.remove', '__name__') }}"></plugin-list>
@endsection
...
@push('footer')
    ...
    >
        <div class="text-start">
            <p>
                You are installing plugin from our Tec community. Those plugins are developed by author
                on <a href="https://marketplace.tecdynamics.co.uk" target="_blank">marketplace.tecdynamics.co.uk</a>.
            </p>
            <p>We (Tec) <strong>won't</strong> support free plugins from Marketplace.</p>
            <p>
